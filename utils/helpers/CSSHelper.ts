...
export class CSSHelper {
    ...
    switch (token.tokenType) {
      case TokenType.color:
        return this.colorTokenValueToCSS(
          (token as ColorToken).value,
          allTokens,
          options
        );
      case TokenType.border:
        return this.borderTokenValueToCSS(
          (token as BorderToken).value,
          allTokens,
          options
        );
      case TokenType.gradient:
        return this.gradientTokenValueToCSS(
      ...
      case TokenType.zIndex:
        return this.dimensionTokenValueToCSS(
          (token as AnyDimensionToken).value,
          allTokens,
          options
        );
      case TokenType.shadow:
        return this.shadowTokenValueToCSS(
          (token as ShadowToken).value,
          allTokens,
          options
        );
      case TokenType.fontWeight:
        return this.fontWeightTokenValueToCSS(
      ...
      case TokenType.string:
        return this.stringTokenValueToCSS(
      ...
      case TokenType.visibility:
        return this.optionTokenValueToCSS(
      ...
      case TokenType.blur:
        return this.blurTokenValueToCSS(
          (token as BlurToken).value,
          allTokens,
          options
        );
      case TokenType.typography:
        return this.typographyTokenValueToCSS(
      ...
      default:
        throw new UnreachableCaseError(
          token.tokenType,
          "Unsupported token type for transformation to CSS:"
        );
    }
  }
  ...
  static dimensionTokenValueToCSS(
    ...
    return `${ColorHelper.roundToDecimals(
      dimension.measure,
      options.decimals
    )}${this.unitToCSS(dimension.unit)}`;
  }
  ...
  static shadowLayerToCSS(
    ...
    return `${value.type === ShadowType.inner ? "inset " : ""}${convertToRem(
      value.x
    )} ${convertToRem(value.y)} ${convertToRem(value.radius)} ${convertToRem(
      value.spread
  ...
  static blurTokenValueToCSS(
    blur: BlurTokenValue,
    allTokens: Map<string, Token>,
    options: TokenToCSSOptions
  ): string {
    const reference = sureOptionalReference(
      blur.referencedTokenId,
      allTokens,
      options.allowReferences
    );
    if (reference) {
    ...
    return `blur(${this.dimensionTokenValueToCSS(
      blur.radius,
      allTokens,
      options
    )})`;
  ...
  static typographyTokenValueToCSS(
    ...
    const data = {
      ...
      textDecoration: decorationReference
        ...
        ? this.textDecorationToCSS(
            typography.textDecoration.value as TextDecoration
          )
        : undefined,
      ...
      fontSize: this.dimensionTokenValueToCSS(
        typography.fontSize,
        allTokens,
        options
      ),
      lineHeight: typography.lineHeight
        ? this.dimensionTokenValueToCSS(
